...
def test(seed):
    ...
    rho_0_g = gaussian_filter(rho_0_init, 3)
    ...
    ax[0, 0].imshow(rho_0[rho_0.shape[0]//2].T, origin='lower', cmap='binary', extent=(0, 5, 0, 5))
    ax[0, 1].imshow(rho_filt_np[rho_0.shape[0]//2].T, origin='lower', cmap='binary', extent=(0, 5, 0, 5))
    ...
    ax[1, 0].imshow(rho_0[rho_0.shape[0]//2].T, origin='lower', cmap='binary', extent=(0, 5, 0, 5))
    ax[1, 1].imshow(rho_filt_np[rho_0.shape[0]//2].T, origin='lower', cmap='binary', extent=(0, 5, 0, 5))
    plt.show()
