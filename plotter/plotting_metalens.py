...
def metalens_robust_intermediate_plot():
    ...
    def plotter(rho_init, rho_final, cur_eps, projection, i):
        ...
        ax[0, 0].imshow(rho_init[rho_init.shape[0] // 4].T, origin='lower', cmap='binary', vmin=0, vmax=1)
        ...
        ax[0, 1].imshow(rho_init[rho_init.shape[0] // 4].T, origin='lower', cmap='binary', vmin=0, vmax=1)
        ...
        ax[0, 2].imshow(rho_init[rho_init.shape[0] // 4].T, origin='lower', cmap='binary', vmin=0, vmax=1)
