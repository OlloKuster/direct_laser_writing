...
plt.plot(loss_eroded, color='silver', linestyle='--', linewidth=1.5, label='eroded')
plt.plot(loss_dilated, color='silver', linewidth=1.5, label='dilated')
...
plt.ylabel(r"$\mathcal{L}_\text{EM}$", fontsize=18)
plt.xlim(1, 50)
plt.ylim(1, 7.4)
plt.legend()
plt.tight_layout()
