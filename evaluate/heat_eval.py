...
target_material = np.round(np.array([-0.99, -0.8, -0.6, -0.4, -0.2]), 1)
# target_void = np.round(np.array([0.8, 1., 1.2, 1.4, 1.6]) - 1, 1)
target_void = np.round(np.array([-0.99, -0.8, -0.6, -0.4, -0.2][::-1]), 1)
print(target_void)
i = 0
...
ax0.set_xlabel(r"$\mathcal{L}_\text{mat}$", fontsize=18)
ax0.set_ylabel(r"$\mathcal{L}_\text{void}$", fontsize=18)
...
ax1.set_xlabel(r"$\mathcal{L}_\text{mat}$", fontsize=18)
...
ax2.set_xlabel(r"$\mathcal{L}_\text{mat}$", fontsize=18)
