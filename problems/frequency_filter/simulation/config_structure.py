...
class ConfigSim:
    ...
    simulation_domain_shape = (int(jnp.ceil(dpml + rho_shape[0] + dpml)),
                               int(jnp.ceil(dpml + rho_shape[1] + dpml)),
    ...
    location_trans_monitor = dpml + buffer_bottom + rho_shape[2] + buffer_top + 0.25
    location_refl_monitor = dpml + buffer_bottom + 0.25
