...
rho_0 = np.concatenate((rho_precomp, np.flip(rho_precomp, axis=0)), axis=0)
...
p.remove_scalar_bar()
p.camera.zoom(1.3)
p.show(screenshot="/scratch/local/okuster/Code/00_Main_Projects/dlw_params/problems/metalens/plots/example_rho.png")
p.close()
