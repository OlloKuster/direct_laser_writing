...
def em_simulation(rho, wavelength, currents, resolution):
    """
    ...
    omega = 2 * jnp.pi / (wavelength * resolution)
    rho_p = rho #preprocess(rho[:-ConfigSim.buffer_side * resolution, :-ConfigSim.buffer_side*resolution], resolution)
