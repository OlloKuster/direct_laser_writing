...
class ConfigSim:
    ...
    buffer_top = 1.5  # Buffer for the mask.
    ...
    TARGET_MATERIAL = 1.3  # Normalizes the target heat_eval for the material. The initial value is 1-TARGET_MATERIAL.
    TARGET_VOID = 1.3  # Normalizes the target heat_eval for the void. The initial value is 1-TARGET_VOID.
