...
def objective_heat_f():
    """
    Generates the pure heat-objective function.
    :return: Pure heat-objective function
    """
    def objective_heat(rho):
        """
        Calculates the heat generated by the material and the void of rho.
        :param rho: Density (design variable) of the problem [0, 1].
        :return: Tuple of material and void heat.
        """
...
def objective_em_heat_f(currents, resolution, init_values):
    ...
    :param init_values: Initial value of the problem to make a unitless comparison possible.
                        Tuple of initial values for the EM, material heat and void heat simulation.
    ...
    def objective_softplus(rho):
        """
        Generates the softplus objective function. Implements the virtual heat method and filters it through a
        non-linear activation function. This is to make sure that once connectivity is reached, the optimizer disregards
        the contributions of the heat solver.
        :param rho: Density (design variable) of the problem [0, 1].
